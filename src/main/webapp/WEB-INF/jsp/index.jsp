...
<head>
    ...
    <link href="<c:url value='/vendors/easypiechart/jquery.easy-pie-chart.css' />" rel="stylesheet" media="screen">
...
<script src="<c:url value='/vendors/easypiechart/jquery.easy-pie-chart.js' />"></script>
